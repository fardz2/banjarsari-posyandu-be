...
import {
  ...
  updatePosyandu,
  deletePosyandu,
} from '../../controllers/posyandu.controller.js';
import { authMiddleware } from '../../middlewares/auth.middleware.js';
import { requireRole } from '../../middlewares/role.middleware.js';
import {
  createPosyanduSchema,
  updatePosyanduSchema,
} from '../../utils/validations/posyandu.validation.js';
...
posyanduRoutes.post(
  ...
  zValidator('json', createPosyanduSchema),
  createPosyandu
);
posyanduRoutes.put(
  '/:id',
  requireRole('SUPER_ADMIN'),
  zValidator('json', updatePosyanduSchema),
  updatePosyandu
);
