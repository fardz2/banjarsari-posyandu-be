...
export const getDashboardSummaryService = async (user: UserContext) => {
  // Define scope based on user role
  // Define specific filters
  let userFilter: any = {};
  let anakFilter: any = {};
  let ibuHamilFilter: any = {};
  let pengukuranFilter: any = {};
  let ortuFilter: any = {};
  let posyanduFilter: any = {};
...
export const getGenderStatsService = async (user: UserContext) => {
  let wherePosyandu: any = {};
...
export const getNutritionalStatsService = async (user: UserContext) => {
  let wherePosyandu: any = {};
...
export const getNutritionalStatsByPosyanduService = async (user: UserContext) => {
  let wherePosyandu: any = {};
  ...
  const initStats = () => ({
    bb_tb: {} as Record<string, number>,
    bb_u: {} as Record<string, number>,
    tb_u: {} as Record<string, number>,
    lk_u: {} as Record<string, number>,
  });

  const statsByPosyandu: Record<string, ReturnType<typeof initStats>> = {};
...
export const getVisitTrendsService = async (user: UserContext) => {
  let wherePosyandu: any = {};
