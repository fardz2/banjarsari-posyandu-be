 ...
 */
export const getForumCommentsService = async (forumId, user, params) => {
...
export const getAllForumsService = async (user, params) => {
    const page = params?.page || 1;
    const limit = params?.limit || 10;
 ...
 */
export const getForumByIdService = async (id, user) => {
    const forum = await prisma.forum.findUnique({
        where: { id },
        include: {
            createdBy: {
 ...
 */
export const createForumService = async (data, userId) => {
 ...
 */
export const updateForumService = async (id, data, user) => {
    const forum = await prisma.forum.findUnique({
        where: { id },
    });
    if (!forum) {
 ...
 */
export const deleteForumService = async (id, user) => {
    const forum = await prisma.forum.findUnique({
        where: { id },
    });
    if (!forum) {
 ...
 */
export const addCommentService = async (forumId, data, user) => {
