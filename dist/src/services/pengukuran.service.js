...
export const getAllPengukuranService = async (requestingUser, filters) => {
...
export const getPengukuranByIdService = async (id, requestingUser) => {
    ...
    requirePosyanduAccess(requestingUser, pengukuran.anak.posyanduId, 'data pengukuran');
    return pengukuran;
};
// SERVICE: Get pengukuran by anak NIK
export const getPengukuranByAnakService = async (anakNik, requestingUser) => {
...
export const updatePengukuranService = async (id, data, requestingUser) => {
...
export const deletePengukuranService = async (id, requestingUser) => {
    // Get existing pengukuran
