...
import { canCreateMedicalData, canUpdateMedicalData, canDeleteMedicalData, getPosyanduFilter, requirePermission, } from '../utils/permission.helper.js';
// Helper to map Prisma result to OrtuResponse
const mapOrtuToResponse = (ortu) => {
    return {
        ...ortu,
...
// SERVICE: Create Ortu
export const createOrtuService = async (data, requestingUser) => {
    requirePermission(canCreateMedicalData(requestingUser.role), 'Anda tidak memiliki permission untuk membuat data orang tua');
