...
import { canCreateMedicalData, canUpdateMedicalData, canDeleteMedicalData, getPosyanduFilter, requirePermission, requirePosyanduAccess, } from '../utils/permission.helper.js';
...
export const createIbuHamilService = async (data, requestingUser) => {
    requirePermission(canCreateMedicalData(requestingUser.role), 'Anda tidak memiliki permission untuk menambah data ibu hamil');
...
export const updateIbuHamilService = async (id, data, requestingUser) => {
    ...
    requirePermission(canUpdateMedicalData(requestingUser.role), 'Anda tidak memiliki permission untuk update data ibu hamil');
...
export const deleteIbuHamilService = async (id, requestingUser) => {
    ...
    requirePermission(canDeleteMedicalData(requestingUser.role), 'Hanya Admin dan Super Admin yang bisa delete data ibu hamil');
